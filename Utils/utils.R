PrepareDataset <- function(DataDirectory,CovariatesTarget,SpectraTarget,LocalDirectory,umap_,
  ...
  return(list(Global_Training=Global_Training,Local_Training=Local_Training,Test=Test,predict_data=NewLocal,predict_locations=LocalData))
}

RunXGB_ITER <- function(SEED=NULL,
                        Global_Training,
                        Local_Training,
                        Test,
                        neighbours_,
  ...
  xgb.save(xgb_Local,paste0('RData/',ReferenceName,'_Local_Model_',SEED,'_450_2350_','_n_',neighbours_,'_',TargetLocal))
  xgb.save(xgb_Global,paste0('RData/',ReferenceName,'_Global_Model_',SEED,'_450_2350_','_n_',neighbours_,'_',TargetLocal))
